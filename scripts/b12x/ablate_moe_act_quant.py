...
Example:
    python scripts/b12x/ablate_moe_act_quant.py \
...
from flashinfer.b12x._lib.fp6 import _decode_fp6_e2m3, _decode_fp6_e3m2
from flashinfer.b12x.quantization.mxfp6.fp6_safetensors_export import _layer_expert_matrices
from flashinfer.b12x.quantization.mxfp6.model_fp6 import SafetensorsModel, discover_moe_experts
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        "(from scripts/b12x/capture_hidden_states.py; pickle rejected); "
    ...
    if args.x_from:
        from flashinfer.b12x.quantization.mxfp6.calib_io import load_hidden_states
