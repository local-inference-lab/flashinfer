...
Examples
--------
    python scripts/b12x/bench_fp6_decode.py
    python scripts/b12x/bench_fp6_decode.py --shapes 6144x5120 5120x5120 13824x5120 5120x13824
"""
...
def main() -> None:
    ...
    import flashinfer.b12x._lib.dense_gemm as _dense_mod
    import flashinfer.b12x.quantization.mxfp6.fp6_dense_weights as _wmod
    from flashinfer.b12x._lib.dense_gemm import dense_gemm
    from flashinfer.b12x.quantization.mxfp6 import dense_fp6_linear, quantize_dense_weight_to_fp6
    from flashinfer.b12x.quantization.mxfp6.fp6_dense_weights import (
