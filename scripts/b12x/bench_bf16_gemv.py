...
Examples
--------
    python scripts/b12x/bench_bf16_gemv.py
    python scripts/b12x/bench_bf16_gemv.py --shapes 96x5120 64x5120 --ms 1 2 4
"""
...
def main() -> None:
    ...
    from flashinfer.b12x.gemm.bf16_gemv._kernel import SMALL_M_MAX
