...
from flashinfer.b12x.attention.paged.tuning.registry import normalize_kv_dtype_key
from flashinfer.b12x.integration.attention import PagedAttentionWorkspace
...
from benchmarks.b12x.sweep_search import SweepSegment
...
def _render_python_module(
    *,
    ...
    lines = [
        '"""Generated by scripts/b12x/sweep_graph_cta_schedule.py."""',
        "",
