...
Run it in BOTH venvs and compare:
    ...
    python scripts/b12x/smoke_bf16_gemv.py --n 96 --k 5120

    # vLLM venv (the crashing one)
    ~/kld-nightly-vllm/venv/bin/python scripts/b12x/smoke_bf16_gemv.py --n 96 --k 5120
...
def main() -> None:
    ...
    from flashinfer.b12x.gemm.bf16_gemv import SMALL_M_MAX
    from flashinfer.b12x.gemm.bf16_gemv._kernel import compile_bf16_gemv_small_n
