...
Quantize a checkpoint:
    python scripts/b12x/quantize_moe_fp6.py --input experts_bf16.safetensors \
        --output experts_fp6.safetensors

Generate + quantize random weights (no checkpoint needed) to smoke-test the path:
    python scripts/b12x/quantize_moe_fp6.py --demo --experts 4 --k 128 --n 128 \
...
from flashinfer.b12x.quantization.mxfp6 import quantize_moe_weights_to_fp6, save_fp6_moe_weights
