...
from flashinfer.b12x._lib.compiler import b12x_package_fingerprint
from flashinfer.b12x._lib.intrinsics import quantize_grouped_nvfp4_torch
from flashinfer.b12x.quantization.nvfp4._impl import allocate_bf16_to_fp4_tma_outputs, compile_bf16_to_fp4_tma
...
def main() -> None:
    ...
    if args.raw_samples_jsonl is not None:
        ...
        record = {
            "schema": "flashinfer.b12x.bf16_to_fp4_tma.graph_abba.v1",
