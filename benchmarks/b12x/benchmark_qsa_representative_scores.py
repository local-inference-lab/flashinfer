...
from flashinfer.b12x.attention.qsa._kernels import launch_score_representatives as triton_score
from flashinfer.b12x.attention.qsa._score_cute import launch_score_representatives as cute_score
...
def main():
    ...
    sources = (
        Path(__file__),
        root / "flashinfer/b12x/attention/qsa/_kernels.py",
        root / "flashinfer/b12x/attention/qsa/_score_cute.py",
    )
    result = {
