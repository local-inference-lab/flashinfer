...
RUN_SCHEMA = {"name": "flashinfer.b12x.pcie_oneshot_control_node.run", "version": 3}
SUITE_SCHEMA = {"name": "flashinfer.b12x.pcie_oneshot_control_node.ab_suite", "version": 3}
RUN_TOP_LEVEL_KEYS = {
    "schema",
    "contract",
    "scope",
...
def _validate_run(
    ...
    *,
    ...
    expected_module = (
        implementation_root / "flashinfer/b12x/comm/pcie/pcie_oneshot.py"
    ).resolve()
