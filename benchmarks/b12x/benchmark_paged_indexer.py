...
import flashinfer.b12x.attention.dsa_indexer.tiled_topk as tiled_topk_module
from flashinfer.b12x.attention.dsa_indexer._impl import uses_paged_mqa_schedule
from flashinfer.b12x.attention.dsa_indexer.kernel import (
    run_paged_supertile_logits_kernel,
)
from flashinfer.b12x.attention.dsa_indexer._impl import clear_indexer_caches
...
def main() -> None:
    ...
    def run() -> torch.Tensor:
        ...
        if bench_mode == "fused-topk":
            ...
            from flashinfer.b12x.attention.dsa_indexer.fused_indexer import run_fused_paged_indexer
