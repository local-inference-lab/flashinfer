...
def _source_metadata(repository: pathlib.Path) -> dict[str, object]:
    paths = (
        ...
        repository / "flashinfer/b12x/_lib/dense_gemm.py",
        repository / "flashinfer/b12x/gemm/mxfp8_linear/_kernel.py",
    )
    try:
...
def main() -> None:
    ...
    result = {
        "schema": "flashinfer.b12x.mxfp8-linear-output-plan-benchmark.v1",
        "status": status,
