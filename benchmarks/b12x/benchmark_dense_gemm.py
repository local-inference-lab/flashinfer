...
from flashinfer.b12x.gemm._shared.block_fp8 import quantize_block_fp8_linear_input_mxfp8
from flashinfer.b12x._lib.dense_gemm import dense_gemm
from flashinfer.b12x.gemm._shared.wo_mxfp8 import empty_mxfp8_rows_for_dense_gemm
...
def main():
    ...
    if args.dtype in ("fp4-a16", "fp8-a16"):
        from benchmarks.b12x.benchmark_blockscaled_precision import run
