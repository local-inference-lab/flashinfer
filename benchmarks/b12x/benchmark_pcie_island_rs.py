...
from flashinfer.b12x._lib import compiler as cute_compiler
from flashinfer.b12x.comm.pcie.pcie_allreduce import PCIeAllReduce
from flashinfer.b12x.comm.pcie.pcie_dcp_a2a import PCIeDCPA2APool
from flashinfer.b12x.comm.pcie.pcie_hierarchical import PCIeHierarchicalAllReduce
from flashinfer.b12x.comm.pcie.pcie_island_rs import PCIeIslandRSAllReduce
...
SOURCE_FILES = (
    "benchmarks/b12x/benchmark_pcie_island_rs.py",
    "flashinfer/b12x/comm/pcie/_island_rs_cute.py",
    "flashinfer/b12x/comm/pcie/pcie_allreduce.py",
    "flashinfer/b12x/comm/pcie/pcie_hierarchical.py",
    "flashinfer/b12x/comm/pcie/pcie_island_rs.py",
)
...
def _source_metadata(repository: Path) -> dict[str, object]:
    ...
    return {
        "repository": "local-inference-lab/flashinfer",
...
def main() -> None:
    ...
    receipt = {
        "schema": "flashinfer.b12x.tp16-pcie-equal-quarter-benchmark.v4",
        "status": status,
