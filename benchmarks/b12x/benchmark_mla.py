...
from flashinfer.b12x.attention._shared.workspace import (
    default_sparse_mla_split_decode_config_for_width,
)
from flashinfer.b12x.attention.dsa_indexer.reference import (
...
from flashinfer.b12x.attention.dsa_indexer.contiguous_kernel import (
    _PREFILL512_BLOCK_K,
    _PREFILL512_BLOCK_Q,
    _PREFILL_BLOCK_Q,
)
from flashinfer.b12x.attention.dsa_indexer.tiled_topk import run_tiled_supertile_topk
from flashinfer.b12x.attention.dsa_indexer.persistent_topk import (
...
from flashinfer.b12x.attention.dsa_indexer.paged import (
    index_topk_fp8,
    prepare_paged_indexer_metadata,
)
from flashinfer.b12x.attention.dsa_indexer.scratch import (
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.preset == TARGET_DSV4_TRACE_PRESET:
        from benchmarks.b12x.benchmark_compressed_sparse_mla import (
