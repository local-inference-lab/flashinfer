...
covered by tests/b12x/moe/test_dynamic_w4a8_trellis.py against the torch
reference in tests/b12x/_reference/trellis_moe.py.

Examples:
  python benchmarks/b12x/benchmark_dynamic_w4a8_trellis.py --tokens 1
  python benchmarks/b12x/benchmark_dynamic_w4a8_trellis.py --tokens 1024 --split
  python benchmarks/b12x/benchmark_dynamic_w4a8_trellis.py --recipe w4a8_mx
"""
...
def main() -> None:
    ...
    from tests.b12x.moe.test_dynamic_w4a8_trellis import _run_trellis_dynamic
    from flashinfer.b12x._lib.compiler import compile as b12x_compile
    import flashinfer.b12x._lib.compiler as compiler_mod
    import tests.b12x.moe.test_dynamic_w4a8_trellis as harness
    ...
    from flashinfer.b12x.moe.fused_moe._impl import current_cuda_stream
