...
def _probe_swizzle(swizzle: str, *, run_pytest: bool) -> dict[str, object]:
    ...
    preg_cmd = [
        sys.executable,
        "benchmarks/b12x/probe_paged_bf16_p_regs.py",
        "--lhs-backend",
        "cpasync",
        "--rhs-backend",
        "tma",
    ...
    pvreg_cmd = [
        sys.executable,
        "benchmarks/b12x/probe_paged_bf16_pv_regs.py",
        "--lhs-backend",
        "cpasync",
        "--rhs-backend",
        "tma",
    ...
    if (
        ...
        pytest_cmd = [
            ...
            "pytest",
            "-q",
            "tests/b12x/test_attention_paged_forward.py::test_paged_forward_matches_reference_without_split",
            "-vv",
        ]
