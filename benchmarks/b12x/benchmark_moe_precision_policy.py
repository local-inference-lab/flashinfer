...
from flashinfer.b12x.policy.generation.contracts import GenerationContext, GenerationSettings
from flashinfer.b12x.policy.generation.moe_corpus import expand_physical_geometries, expand_sweep_cases
from flashinfer.b12x.policy.generation.moe_corpus import MoeSweepCase
from flashinfer.b12x.policy.generation.progress import NullProgressReporter
from flashinfer.b12x.policy.generation.providers.moe import MoeDecodeGenerator
from flashinfer.b12x.policy.generation.providers.moe_precision import source_identity
from flashinfer.b12x.policy.generation.store import CheckpointStore
...
def snapshot_factory(weights, inputs):
    ...
    from flashinfer.b12x.policy.generation.providers.moe_gpu_worker import _MoeGeometrySession, _QueryInputs
    from benchmarks.b12x.benchmark_moe import get_quant_mode_params
...
def main():
    ...
    if args.input_snapshot:
        import torch
        from benchmarks.b12x.moe_checkpoint_snapshot import load_snapshot
