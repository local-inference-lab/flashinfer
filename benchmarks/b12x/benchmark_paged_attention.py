...
from flashinfer.b12x.attention.paged.workspace import PagedAttentionWorkspace
...
from flashinfer.b12x.attention.paged._scratch import build_paged_attention_binding
from flashinfer.b12x.attention.paged.traits import select_paged_forward_traits_from_plan
from flashinfer.b12x._lib import b12x_package_fingerprint
...
def _initialize_raw_sample_log(
    ...
    *,
    ...
    benchmark_dependencies = {
        ...
        for path in (benchmark_path, repo / "benchmarks" / "b12x" / "common.py")
    }
