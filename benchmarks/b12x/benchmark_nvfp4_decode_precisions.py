...
from flashinfer.b12x.moe._shared.kernels.reference import moe_reference_nvfp4
from benchmarks.b12x.benchmark_moe import (
    MODEL_PROFILES,
    bench_events,
    build_model_spec,
...
from benchmarks.b12x.benchmark_w4a16_nvfp4_layouts import (
    _check,
    _gpu_snapshot,
    _sha256,
    _weight_hashes,
...
from benchmarks.b12x.moe_checkpoint_snapshot import load_snapshot, save_snapshot, tensor_digest
    ...
    report = {
        ...
        "source_sha256": {
            ...
            for path in (
                ...
                Path("benchmarks/b12x/benchmark_w4a16_nvfp4_layouts.py"),
                Path("benchmarks/b12x/benchmark_moe.py"),
                Path("benchmarks/b12x/common.py"),
                Path("benchmarks/b12x/moe_checkpoint_snapshot.py"),
                Path("flashinfer/b12x/moe/fused_moe/_impl.py"),
                Path("flashinfer/b12x/moe/_shared/kernels/w4a16/kernel.py"),
                Path("flashinfer/b12x/moe/_shared/kernels/w4a16/prepare.py"),
                Path("flashinfer/b12x/moe/_shared/kernels/micro.py"),
                Path("flashinfer/b12x/moe/_shared/kernels/dynamic.py"),
                Path("flashinfer/b12x/moe/_shared/kernels/reference.py"),
                Path("flashinfer/b12x/_lib/intrinsics.py"),
            )
        },
