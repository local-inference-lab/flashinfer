...
Vendored from ``benchmarks/b12x/benchmark_dense_gemm.py`` so the FP6 benchmarks do
...
from benchmarks.b12x.common import (  # noqa: F401  (re-exported for the fp6 benches)
    make_l2_flush_fn,
