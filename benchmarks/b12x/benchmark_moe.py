...
from flashinfer.b12x.moe._shared.kernels.reference_flashinfer import (
...
from flashinfer.b12x._lib.intrinsics import as_grouped_scale_view, swizzle_block_scale
from benchmarks.b12x.common import make_l2_flush_fn, resolve_l2_flush_bytes
from tests.b12x._reference.w4a16_reference import moe_reference_w4a16
...
def make_shape_only_expert_weights(
    ...
    *,
    ...
    if source_format == "fp4_e8m0_k32":
        from benchmarks.b12x.benchmark_ds4_moe import _make_quantized_stack
...
def load_expert_weights(
    ...
    *,
    ...
    from benchmarks.b12x.checkpoint_loader import IndexedSafetensorLoader
...
def plan_b12x_benchmark_weights(
    ...
    *,
    ...
    from flashinfer.b12x.moe.fused_moe._impl import plan_b12x_fp4_moe_weights
    from flashinfer.b12x.moe._shared.execution import PreparedWeightLayout
...
def prepare_b12x_benchmark_weights(
    ...
    *,
    ...
    from flashinfer.b12x.moe.fused_moe._impl import prepare_b12x_fp4_moe_weights
...
def force_convert_nvfp4_weights_to_mxfp4(
    ...
    *,
    ...
    from benchmarks.b12x.benchmark_ds4_moe import quantize_mxfp4_batched
...
def _clear_b12x_caches() -> None:
    from flashinfer.b12x.moe.fused_moe._impl import clear_tp_moe_caches

    clear_tp_moe_caches()
    try:
        from flashinfer.b12x.moe._shared.kernels.w4a16.kernel import clear_w4a16_kernel_cache
    except ImportError:
        return
...
def allocate_layer_chain_workspace():
    from flashinfer.b12x.moe.fused_moe._impl import allocate_tp_moe_workspace_pool
...
def run_moe_layer_chain(
    ...
    *,
    ...
    from flashinfer.b12x.moe.fused_moe._impl import b12x_moe_fp4, build_tp_moe_fp4_binding
...
def bench_e2e() -> None:
    from flashinfer.b12x.moe.fused_moe._impl import default_moe_quant_mode
    ...
    from flashinfer.b12x.moe.fused_moe._impl import (
    ...
    w4a16_moe = None
    if use_w4a16:
        from flashinfer.b12x.moe._shared.kernels.w4a16.kernel import run_w4a16_moe
    ...
    for batch_size in batch_sizes:
        ...
        from flashinfer.b12x.moe.fused_moe import _impl as fused_moe_impl
