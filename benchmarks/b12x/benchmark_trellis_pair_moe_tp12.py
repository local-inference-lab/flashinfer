...
Example:
    ...
    B12X_COMPILE_DISK_CACHE=0 \
      python benchmarks/b12x/benchmark_trellis_pair_moe_tp12.py \
...
try:
    from benchmarks.b12x.common import make_l2_flush_fn, nvidia_smi_gpu_mode_snapshot
except ModuleNotFoundError:  # Direct ``python benchmarks/b12x/...py`` execution.
    from common import make_l2_flush_fn, nvidia_smi_gpu_mode_snapshot
from flashinfer.b12x.moe import fused_moe
from flashinfer.b12x.moe._shared.kernels.w4a16.btx_compat import (
...
def _source_sha256() -> str:
    ...
    paths = (
        ...
        root / "flashinfer/b12x/_lib/intrinsics.py",
        root / "flashinfer/b12x/gemm/trellis_linear/api.py",
        root / "flashinfer/b12x/moe/_shared/execution.py",
        root / "flashinfer/b12x/moe/_shared/kernels/w4a16/kernel.py",
        root / "flashinfer/b12x/moe/_shared/kernels/w4a16/prepare.py",
        root / "flashinfer/b12x/moe/fused_moe/_impl.py",
    )
    digest = hashlib.sha256()
    for path in paths:
