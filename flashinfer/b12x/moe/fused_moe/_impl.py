...
from flashinfer.b12x._lib.compiler import (
    KernelCompileSpec,
    compile as b12x_compile,
)
from flashinfer.b12x._lib.intrinsics import (
    align_up,
    as_grouped_scale_view,
    swizzle_block_scale,
)
from flashinfer.b12x._lib.utils import (
    current_cuda_stream,
...
from flashinfer.b12x.moe._shared.routing import (
    route_topk as triton_route_topk,
)
from flashinfer.b12x.moe._shared.kernels.relu2 import (
    MoEDynamicKernelRelu2,
    MoEMicroKernelRelu2,
)
from flashinfer.b12x.moe._shared.kernels.silu import (
    MoEDynamicKernelSilu,
    MoEDynamicKernelSwiGLUOAI,
    MoEMicroKernelSilu,
    MoEMicroKernelSwiGLUOAI,
)
from flashinfer.b12x.moe._shared.kernels.situ import (
    MoEDynamicKernelSitu,
    MoEMicroKernelSitu,
)
from flashinfer.b12x.moe._shared.kernels.activations import (
    SITU,
...
from flashinfer.b12x.moe._shared.trellis_codebooks import SQG_E4M3
from flashinfer.b12x.moe._shared.tuning import lookup_max_active_clusters
from flashinfer.b12x.policy import (
    DeviceIdentity,
...
from flashinfer.b12x._lib.scratch import (
    ScratchBufferSpec,
    scratch_buffer_spec,
    scratch_tensor,
)
...
def clear_tp_moe_caches() -> None:
    ...
    """
    from flashinfer.b12x.moe._shared.kernels.w4a16.kernel import (
...
def _arena_core_token_counts(
    *,
    ...
    if quant_mode == "w4a16" and bucket_w4a16_tokens:
        from flashinfer.b12x.moe._shared.kernels.w4a16.host import (
...
def _derive_w4a8_weight_grids(
    ...
    from flashinfer.b12x.moe._shared.kernels.reference import (
...
def _prepare_w6a8_from_mxfp6_source(
    *,
    ...
    """
    from flashinfer.b12x.moe._shared.kernels.w6a8 import prepare_w6a8_mxfp6_weights
...
def prepare_b12x_fp4_moe_weights(
    *,
    ...
    if plan.source_format == "btx":
        from flashinfer.b12x.moe._shared.kernels.w4a16.btx import (
            BtxLayer,
    ...
    if WeightPreparationTransform.W4A16_NATIVE in plan.transforms:
        ...
        from flashinfer.b12x.moe._shared.kernels.w4a16.prepare import (
...
def prepare_b12x_trellis_v2_weights(
    *,
    ...
    from flashinfer.b12x.moe.fused_moe.config import TrellisConfig
    from flashinfer.b12x.moe.fused_moe.trellis import prepare_trellis_weights
    from flashinfer.b12x.moe.fused_moe.weights import TrellisWeights
...
def prewarm_w4a16_fc2_e8m0(experts, *, route_ids_dtype: torch.dtype) -> None:
    ...
    from flashinfer.b12x.moe._shared.kernels.w4a16 import kernel as w4a16_kernel
    from flashinfer.b12x.moe._shared.kernels.w4a16.prepare import W4A16FC2Weights
...
def run_w4a16_fc2_e8m0(
    ...
    *,
    ...
    from flashinfer.b12x.moe._shared.kernels.w4a16 import kernel as _w4a16_kernel  # noqa: F401
    from flashinfer.b12x.moe._shared.kernels.w4a16.prepare import W4A16FC2Weights
...
def _plan_projection_mixed_trellis_launches(
    *,
    ...
    from flashinfer.b12x.moe._shared.kernels.w4a16.host import max_packed_route_slots
    from flashinfer.b12x.moe._shared.kernels.w4a16.kernel import _DEFAULT_MAX_SHARED_MEM
    from flashinfer.b12x.moe._shared.kernels.w4a16.mixed_trellis import (
        MixedTrellisBuffers,
...
def _bind_projection_mixed_trellis_from_views(
    *,
    ...
    from flashinfer.b12x.moe.fused_moe.trellis import PreparedProjectionTrellisWeights
...
def _resolve_trellis_route_block_size(caps: TPMoEScratchCaps) -> int | None:
    ...
    if _normalize_quant_mode(caps.quant_mode) != "w4a16":
        ...
        return None
    from flashinfer.b12x.moe._shared.kernels.w4a16.host import select_route_block_size_m
...
def _get_tiny_decode_kernel(
    ...
    *,
    ...
    from flashinfer.b12x.moe._shared.kernels.tiny_decode import (
