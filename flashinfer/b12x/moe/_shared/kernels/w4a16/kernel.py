...
from flashinfer.b12x._lib.quant.sqg_e4m3 import sqg_xor_cheb_t12_lut
from flashinfer.b12x.moe._shared.kernels.trellis_ring import (
    trellis256_lane_geom_bits as _trellis_ring_lane_geom_bits,
)
from flashinfer.b12x.moe._shared.trellis_codebooks import (
    MCG,
    SQG_E4M3,
    SQG_FP16,
    validate_codebook_bits,
)
from flashinfer.b12x._lib.quant.sqg_fp16_d3l import (
    sqg_fp16_d3l_descriptors,
)
from flashinfer.b12x._lib.utils import current_cuda_stream, make_ptr
from flashinfer.b12x.moe._shared.kernels.w4a16.route_pack import (
...
def run_w4a16_moe(
    ...
    *,
    ...
    if use_x4t_scale_predecode:
        ...
        from flashinfer.b12x._lib.quant.x4t_scales import (
