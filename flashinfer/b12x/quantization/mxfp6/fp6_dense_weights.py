...
from flashinfer.b12x._lib.dense_gemm import dense_gemm, _DENSE_FUSED_QUANT
...
def _small_m_quant_scratch(m_pad: int, k: int, device: torch.device) -> tuple:
    ...
    """
    from flashinfer.b12x.quantization.mxfp6 import allocate_bf16_to_fp6_tma_outputs
...
def _quantize_matrix_fp6_bytes_per_row(
    ...
    from flashinfer.b12x.quantization.mxfp6.fp6_row_gs import compile_fp6_row_gs
...
def _quantize_matrix_fp6_bytes_small_m(
    ...
    """
    from flashinfer.b12x.quantization.mxfp6.bf16_to_fp6_small_m import (
...
class FP6DenseWeight:
    ...
    def expanded_weight(self) -> torch.Tensor:
        ...
        if self._packed_expanded is None:
            ...
            from flashinfer.b12x._lib.dense_gemm import _expand_packed_mxfp6_ab
