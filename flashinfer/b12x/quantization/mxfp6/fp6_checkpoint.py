...
def _pack_codes(mat_bf16: torch.Tensor, fmt: str, *, use_gpu: bool) -> torch.Tensor:
    ...
    from flashinfer.b12x._lib.fp6 import quantize_grouped_mxfp6_torch
...
def _pack_codes_and_scales_mse(
    ...
    """
    from flashinfer.b12x._lib.fp6 import pack_fp6_codes_tensor
...
def dequantize_linear_from_fp6(
    ...
    *,
    ...
    """
    from flashinfer.b12x._lib.fp6 import expand_mxfp6_packed_to_bytes
