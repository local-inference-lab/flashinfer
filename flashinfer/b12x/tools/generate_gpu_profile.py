...
from flashinfer.b12x.policy.generation.parallel import run_parallel_measurements
from flashinfer.b12x.policy.generation.progress import RichProgressReporter
from flashinfer.b12x.policy.generation.runner import (
    estimate_generators,
...
_GENERATED_PROFILE_DATA = Path("flashinfer/b12x/policy/_profiles/data")
_GENERATED_PROFILE_PATHSPEC = ":(exclude)flashinfer/b12x/policy/_profiles/data/*.json*"
...
def _package_source_revision() -> str:
    ...
    package_root = _REPO_ROOT / "flashinfer" / "b12x"
...
def _profile_output_paths(
    ...
    *,
    ...
    generated_output = (
        Path("validation/b12x/gpu_profiles/generated") / f"{profile_id}.json.gz"
    ).resolve()
