...
class B12XFP6LinearMethod:
    ...
    def apply(
        ...
        from flashinfer.b12x.quantization.mxfp6 import dense_fp6_linear
...
def load_b12x_fp6_moe_methods(
    ...
    *,
    ...
    from flashinfer.b12x.moe import fused_moe
    from flashinfer.b12x.quantization.mxfp6 import load_fp6_moe_checkpoint
...
def load_b12x_fp6_linear_methods(
    ...
    *,
    ...
    from flashinfer.b12x.quantization.mxfp6 import load_fp6_dense_checkpoint
