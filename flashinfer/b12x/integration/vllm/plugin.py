...
from flashinfer.b12x.integration.vllm.fp6_serving import (
    QUANT_ALGO,
    QUANT_METHOD,
    B12XFP6MoEMethod,
...
from flashinfer.b12x.gemm.bf16_gemv import (  # noqa: E402
...
def register_b12x_fp6() -> None:
    ...
    class _VllmLinearMethod(LinearMethodBase):  # type: ignore[misc]
        ...
        def process_weights_after_loading(self, layer: Any) -> None:
            from flashinfer.b12x.quantization.mxfp6.fp6_checkpoint import (
                resolve_activation_format,
            )
            from flashinfer.b12x.quantization.mxfp6.fp6_dense_weights import PACKED_GEMM_MIN_N
            ...
            import flashinfer.b12x.quantization.mxfp6.fp6_dense_op  # noqa: F401
    ...
    class _VllmSmallNBF16Method(UnquantizedLinearMethod):  # type: ignore[misc]
        def process_weights_after_loading(self, layer: Any) -> None:
            ...
            import flashinfer.b12x.gemm.bf16_gemv  # noqa: F401
    ...
    class B12XFp6Config(QuantizationConfig):  # type: ignore[misc]
        ...
        def _ensure_loaded(self) -> None:
            ...
            from flashinfer.b12x.quantization.mxfp6.fp6_checkpoint import WEIGHT_SCALE_SUFFIX
            from flashinfer.b12x.quantization.mxfp6.fp6_safetensors_load import (
                _source_format_from_config,
            )
            from flashinfer.b12x.quantization.mxfp6.model_fp6 import SafetensorsModel
            from flashinfer.b12x.quantization.mxfp6.fp6_checkpoint import (
...
def _dense_weight_from_loaded(
    ...
    *,
    ...
    from flashinfer.b12x.quantization.mxfp6.fp6_dense_weights import FP6DenseWeight
