...
PLANNING_COMPONENTS = (
    PlanningComponentRegistration(
        ...
        policy_ref=(
            "flashinfer.b12x.attention.compressed_sparse_mla._policy:COMPRESSED_SPARSE_MLA_POLICY"
        ),
        generator_ref=(
            "flashinfer.b12x.policy.generation.providers.attention:"
    ...
    PlanningComponentRegistration(
        ...
        policy_ref="flashinfer.b12x.attention.dense_mla._policy:DENSE_MLA_POLICY",
        generator_ref=(
            "flashinfer.b12x.policy.generation.providers.attention:MlaAttentionGenerator"
        ),
    ),
    PlanningComponentRegistration(
        ...
        policy_ref="flashinfer.b12x.attention.dsa_indexer._policy:DSA_INDEXER_POLICY",
        generator_ref=(
            "flashinfer.b12x.policy.generation.providers.tunable:DsaIndexerProfileGenerator"
        ),
    ),
    PlanningComponentRegistration(
        ...
        policy_ref="flashinfer.b12x.attention.paged._policy:GQA_POLICY",
        generator_ref=(
            "flashinfer.b12x.policy.generation.providers.attention:GqaAttentionGenerator"
        ),
    ),
    PlanningComponentRegistration(
        ...
        policy_ref="flashinfer.b12x.attention.qsa._policy:QSA_POLICY",
        generator_ref=(
            "flashinfer.b12x.policy.generation.providers.attention:QsaAttentionGenerator"
        ),
    ),
    PlanningComponentRegistration(
        ...
        policy_ref="flashinfer.b12x.attention.sparse_mla._policy:SPARSE_MLA_POLICY",
        generator_ref=(
            "flashinfer.b12x.policy.generation.providers.qualification:SparseMlaGenerator"
        ),
    ),
    PlanningComponentRegistration(
        ...
        policy_ref="flashinfer.b12x.attention.varlen._policy:VARLEN_ATTENTION_POLICY",
        generator_ref=(
            "flashinfer.b12x.policy.generation.providers.tunable:VarlenAttentionGenerator"
        ),
    ),
    PlanningComponentRegistration(
        ...
        policy_ref=(
            "flashinfer.b12x.gemm.bf16_vocab_projection._policy:"
            "BF16_VOCAB_PROJECTION_POLICY"
        ),
        generator_ref=(
            "flashinfer.b12x.policy.generation.providers.gemm:"
    ...
    PlanningComponentRegistration(
        ...
        policy_ref=("flashinfer.b12x.gemm.block_fp8_linear._policy:BLOCK_FP8_LINEAR_POLICY"),
        generator_ref=(
            "flashinfer.b12x.policy.generation.providers.gemm:BlockFp8LinearGenerator"
        ),
    ),
    PlanningComponentRegistration(
        ...
        policy_ref="flashinfer.b12x.gemm.wo_projection._policy:WO_PROJECTION_POLICY",
        generator_ref=(
            "flashinfer.b12x.policy.generation.providers.gemm:WoProjectionGenerator"
        ),
    ),
    PlanningComponentRegistration(
        ...
        policy_ref="flashinfer.b12x.moe.fused_moe._policy:MOE_DECODE_POLICY",
        generator_ref="flashinfer.b12x.policy.generation.providers.moe:MoeDecodeGenerator",
    ),
    PlanningComponentRegistration(
        op_qualname="moe.ep_moe",
        mode=PlanningPolicyMode.PROFILED,
        component_id=EP_MOE,
        policy_ref="flashinfer.b12x.moe.ep_moe._policy:EP_MOE_POLICY",
        generator_ref=(
            "flashinfer.b12x.policy.generation.providers.qualification:EpMoeGenerator"
        ),
    ),
    PlanningComponentRegistration(
        ...
        policy_ref=("flashinfer.b12x.norm.hyperconnection._policy:HYPERCONNECTION_POLICY"),
        generator_ref=(
            "flashinfer.b12x.policy.generation.providers.norm_sequence:"
    ...
    PlanningComponentRegistration(
        ...
        mode=PlanningPolicyMode.PROFILED,
        component_id=MHC,
        policy_ref="flashinfer.b12x.norm.mhc._policy:MHC_POLICY",
        generator_ref=(
            "flashinfer.b12x.policy.generation.providers.norm_sequence:MhcGenerator"
        ),
    ),
    PlanningComponentRegistration(
        ...
        policy_ref=("flashinfer.b12x.quantization.nvfp4._policy:NVFP4_QUANTIZATION_POLICY"),
        generator_ref=(
            "flashinfer.b12x.policy.generation.providers.tunable:"
    ...
    PlanningComponentRegistration(
        ...
        policy_ref="flashinfer.b12x.sequence.gdn_decode._policy:GDN_POLICY",
        generator_ref=(
            "flashinfer.b12x.policy.generation.providers.attention:GdnAttentionGenerator"
        ),
    ),
    PlanningComponentRegistration(
        ...
        policy_ref=("flashinfer.b12x.sequence.mtp_feedback._policy:MTP_FEEDBACK_POLICY"),
        generator_ref=(
            "flashinfer.b12x.policy.generation.providers.norm_sequence:MtpFeedbackGenerator"
        ),
    ),
    PlanningComponentRegistration(
        ...
        mode=PlanningPolicyMode.PROFILED,
        component_id=PLE,
        policy_ref="flashinfer.b12x.sequence.ple._policy:PLE_POLICY",
        generator_ref="flashinfer.b12x.policy.generation.providers.ple:PleGenerator",
    ),
    PlanningComponentRegistration(
        op_qualname="sequence.ple_embedding",
        mode=PlanningPolicyMode.PROFILED,
        component_id=PLE_EMBEDDING,
        policy_ref=("flashinfer.b12x.sequence.ple_embedding._policy:PLE_EMBEDDING_POLICY"),
        generator_ref=(
            "flashinfer.b12x.policy.generation.providers.ple:PleEmbeddingGenerator"
        ),
    ),
    PlanningComponentRegistration(
        ...
        policy_ref="flashinfer.b12x.sequence.ple_hash._policy:PLE_HASH_POLICY",
        generator_ref=(
            "flashinfer.b12x.policy.generation.providers.ple:PleHashGenerator"
        ),
    ),
)
...
ONESHOT_COMPONENTS = (
    PlanningComponentRegistration(
        ...
        policy_ref="flashinfer.b12x.gemm.blockscaled._policy:BLOCKSCALED_POLICY",
        generator_ref="flashinfer.b12x.policy.generation.providers.blockscaled:BlockscaledPrecisionGenerator",
    ),
)
