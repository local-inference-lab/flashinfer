...
def source_identity():
    ...
    paths = (
        *sorted((root / "flashinfer/b12x/moe").rglob("*.py")),
        *sorted((root / "flashinfer/b12x/_lib").rglob("*.py")),
        *sorted((root / "flashinfer/b12x/policy/generation").rglob("*.py")),
        root / "benchmarks/b12x/benchmark_blockscaled_precision.py",
        root / "benchmarks/b12x/benchmark_w4a16_nvfp4_layouts.py",
        root / "benchmarks/b12x/benchmark_moe.py",
        root / "tests/b12x/_reference/w4a16_reference.py",
    )
...
def measure_precision(session, case, candidates):
    ...
    from benchmarks.b12x.moe_checkpoint_snapshot import tensor_digest
