...
class _PleLayerProbe:
    ...
    def case_count(self) -> int:
        from benchmarks.b12x.benchmark_ple import LAYER_PROFILES
    ...
    def __call__(
        ...
        from benchmarks.b12x.benchmark_ple import (
            LAYER_PROFILES,
            _address_tensors,
            _time_case,
            _validate_layer,
...
class _PleHashProbe:
    @property
    def case_count(self) -> int:
        from benchmarks.b12x.benchmark_ple import PACKED_PROFILES
