...
def _build_gdn_buffers(
    ...
    *,
    ...
    from flashinfer.b12x.policy import GDN_ATTENTION, PolicyContext, PolicyMode
    from flashinfer.b12x.sequence import gdn_decode as gdn
    from flashinfer.b12x.sequence.gdn_decode._policy import GdnConfig
...
class _GqaSession(AbstractContextManager["_GqaSession"]):
    ...
    def _capacity(
        ...
        *,
        ...
        from flashinfer.b12x.attention import paged
    ...
    def candidates(self, case: SweepCase) -> tuple[SweepCandidate, ...]:
        ...
        if cached is not None:
            return cached
        from flashinfer.b12x.attention.paged._policy import GqaConfig
    ...
    def measure(
        ...
        from flashinfer.b12x.policy import GQA_ATTENTION, PolicyContext, PolicyMode
...
def _dense_mla_caps(
    ...
    *,
    ...
    from flashinfer.b12x.attention import dense_mla
...
class _SparseMlaSession(AbstractContextManager["_SparseMlaSession"]):
    ...
    def candidates(self, case: SweepCase) -> tuple[SweepCandidate, ...]:
        ...
        from flashinfer.b12x.attention._shared.mla.compressed_config import (
