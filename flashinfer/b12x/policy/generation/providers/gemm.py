...
from flashinfer.b12x.policy.components import BF16_VOCAB_PROJECTION, BLOCK_FP8_LINEAR
...
class _Bf16VocabProjectionSession(
    ...
    def measure(
        ...
        from flashinfer.b12x.gemm import bf16_vocab_projection as projection
...
class _BlockFp8Session(AbstractContextManager["_BlockFp8Session"]):
    ...
    def measure(
        ...
        from flashinfer.b12x.gemm import block_fp8_linear as block_fp8
        from flashinfer.b12x.gemm._shared.wo_mxfp8 import dequantize_mxfp8_rows_torch
        from flashinfer.b12x.gemm.block_fp8_linear._policy import BlockFp8LinearConfig
        from flashinfer.b12x.policy import PolicyContext, PolicyMode
...
class _WoProjectionProbe:
    ...
    def __call__(
        ...
        from benchmarks.b12x.benchmark_wo_projection import bench_one
