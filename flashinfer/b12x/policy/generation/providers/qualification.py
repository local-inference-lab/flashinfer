...
from flashinfer.b12x.policy.generation.contracts import GenerationContext
from flashinfer.b12x.policy.generation.attention_corpus import (
    COMMON_PREFILL_TOKEN_CAPACITIES,
    COMMON_SEQUENCE_CAPACITIES,
)
from flashinfer.b12x.policy.generation.measured import (
    GpuProbeMeasurement,
...
class _DsaIndexerProbe:
    ...
    def __call__(
        ...
        from benchmarks.b12x.benchmark_dsa_indexer import (
            GLMNSAConfig,
            _run_decode_case,
            _run_extend_case,
        )
        from benchmarks.b12x.benchmark_msa_indexer import (
            _make_decode_case,
            _make_prefill_case,
        )
        from flashinfer.b12x.attention.dsa_indexer._impl import (
            msa_q2k_indices_decode,
            msa_q2k_indices_prefill,
        )
        from flashinfer.b12x.attention.dsa_indexer.msa_reference import (
            MSA_BLOCK_TOKENS,
            MSA_TOPK_BLOCKS,
...
class _SparseMlaProbe:
    ...
    def __call__(
        ...
        from flashinfer.b12x.attention import sparse_mla
        from flashinfer.b12x.attention._shared.mla.reference import (
            pack_mla_kv_cache_reference,
        )
        from flashinfer.b12x.attention._shared.mla.traits import ModelType
        from flashinfer.b12x.attention.sparse_mla.reference import sparse_mla_reference
        from flashinfer.b12x.policy import PolicyContext, PolicyMode
        from benchmarks.b12x.benchmark_unified_mla_sm120 import _make_glm_inputs
...
class _EpMoeProbe:
    ...
    def __call__(
        ...
        from flashinfer.b12x.moe import ep_moe, fused_moe
        from flashinfer.b12x.policy import PolicyContext, PolicyMode
...
class EpMoeGenerator(MeasuredPolicyGenerator):
    ...
    def __init__(self) -> None:
        from flashinfer.b12x.moe.ep_moe._policy import EP_MOE_POLICY, EpMoeQuery
