...
from flashinfer.b12x.policy.components import DSA_INDEXER, NVFP4_QUANTIZATION, VARLEN_ATTENTION
from flashinfer.b12x.policy.generation.contracts import (
    ComponentGenerationResult,
    GenerationContext,
    WorkEstimate,
)
from flashinfer.b12x.policy.generation.reducer import decision_node_to_dict
from flashinfer.b12x.policy.types import DecisionNode, ProfileLeaf
from flashinfer.b12x.policy.generation.sweep import (
...
class _Nvfp4Session(AbstractContextManager["_Nvfp4Session"]):
    ...
    def measure(
        ...
        from flashinfer.b12x.quantization import nvfp4
        from flashinfer.b12x.quantization.nvfp4._policy import Nvfp4QuantizationConfig
...
def _attention_reference(case: SweepCase, q, k, v, cu_q, cu_k):
    ...
    from flashinfer.b12x.attention.paged.reference import attention_reference
...
class _VarlenAttentionSession(
    ...
    def measure(
        ...
        from flashinfer.b12x.attention.varlen._policy import VarlenAttentionConfig
        from flashinfer.b12x.policy import PolicyContext, PolicyMode
...
class _DsaIndexerMergeSession(AbstractContextManager["_DsaIndexerMergeSession"]):
    ...
    def measure(
        ...
        from flashinfer.b12x.attention.dsa_indexer._policy import DsaIndexerConfig
        from flashinfer.b12x.attention.dsa_indexer.fused_indexer import (
