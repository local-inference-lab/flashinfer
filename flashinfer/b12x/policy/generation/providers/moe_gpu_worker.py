...
def _packed_weights(
    ...
    *,
    ...
    from flashinfer.b12x.moe import fused_moe
    from flashinfer.b12x.moe._shared.kernels.activations import moe_activation_w1_rows
...
def _uniform_w4a16_reference(
    ...
    *,
    ...
    from flashinfer.b12x.moe._shared.kernels.activations import is_gated_moe_activation
    ...
    def _prepare_candidate(
        ...
        *,
        ...
        if self._geometry.recipe.quant_mode == "nvfp4_auto":
            import flashinfer.b12x as b12x
