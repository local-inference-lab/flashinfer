...
from flashinfer.b12x.policy.components import HYPERCONNECTION, MHC, MTP_FEEDBACK
...
class _HyperConnectionSession(_GpuSession):
    ...
    def measure(
        ...
        from flashinfer.b12x.norm.hyperconnection._policy import HyperConnectionConfig
        from flashinfer.b12x.policy import PolicyContext, PolicyMode
        from benchmarks.b12x.benchmark_hyperconnection import (
            Profile,
            _graph_samples_us,
            _make_case,
        )
...
class _MtpFeedbackSession(_GpuSession):
    ...
    def measure(
        ...
        from flashinfer.b12x.policy import PolicyContext, PolicyMode
        from flashinfer.b12x.sequence.mtp_feedback._policy import MtpFeedbackConfig
        from benchmarks.b12x.benchmark_mtp_feedback import Profile, _benchmark_profile
...
class _MhcSession(_GpuSession):
    def candidates(self, case: SweepCase) -> tuple[SweepCandidate, ...]:
        from flashinfer.b12x.norm.mhc._policy import MHC_POLICY, MhcConfig, MhcQuery
    ...
    def measure(
        ...
        from flashinfer.b12x.norm.mhc._policy import MhcConfig
        from flashinfer.b12x.policy import PolicyContext, PolicyMode
        from benchmarks.b12x.benchmark_residual import (
            _make_inputs,
            _mhc_pre_reference,
            _post_pre_reference,
        )
...
class MhcGenerator(DiscreteSweepGenerator):
    ...
    def reviewed_queries(self):
        from flashinfer.b12x.norm.mhc._policy import MhcQuery
