"""flashinfer.b12x — consumer-Blackwell (SM120/SM121) kernels.
...
- ops live at ``flashinfer.b12x.<group>.<op>`` and declare themselves via ``META``;
...
This subpackage loads its kernels and torch custom ops lazily. Python first
initializes the parent flashinfer package, including its normal dependencies.
"""
