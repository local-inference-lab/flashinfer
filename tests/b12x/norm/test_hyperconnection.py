...
def test_projection_slices_match_packed_inputs_under_frozen_replay() -> None:
    ...
    from flashinfer.b12x.norm.hyperconnection import _cute, _kernels
...
def test_cute_combine_norm_dispatch_contract_is_explicit() -> None:
    from flashinfer.b12x.norm.hyperconnection import _cute_config
...
def test_cute_reference_helpers_reuse_binaries_across_live_counts(
    ...
    from flashinfer.b12x import freeze_kernel_resolution, unfreeze_kernel_resolution
    from flashinfer.b12x.norm.hyperconnection import _cute
