...
from flashinfer.b12x._lib.fp6 import (
    FLOAT6_E3M2_MAX,
    SF_VEC_SIZE_FP6,
    _encode_fp6_nearest,
...
from flashinfer.b12x._lib.utils import mxfp6_packed_k_bytes
from flashinfer.b12x._lib.dense_gemm import dense_gemm
from flashinfer.b12x.quantization.mxfp6 import allocate_bf16_to_fp6_tma_outputs, compile_bf16_to_fp6_tma
...
def test_moe_fp6_synthetic_smoke() -> None:
    ...
    require_b12x()
    from flashinfer.b12x.integration.tp_moe import (  # retired pre-facade API (module TODO)
...
def test_fp6_safetensors_loader_matches_pt_path() -> None:
    ...
    """
    require_b12x()
    from flashinfer.b12x.quantization.mxfp6 import (
...
def test_fp6_serving_moe_method_apply() -> None:
    ...
    pytest.skip("pending: fused_moe-based rewrite")
    require_b12x()
    from flashinfer.b12x.integration.fp6_serving import B12XFP6MoEMethod  # retired pre-facade API (module TODO)
    from flashinfer.b12x.quantization.mxfp6 import quantize_moe_weights_to_fp6
