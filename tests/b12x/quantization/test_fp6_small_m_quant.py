...
def test_small_m_compile_guards():
    from flashinfer.b12x.quantization.mxfp6.bf16_to_fp6_small_m import compile_bf16_to_fp6_small_m
...
def test_small_m_per_row_linear_ab_bit_exact(m, monkeypatch):
    ...
    from flashinfer.b12x.quantization.mxfp6 import fp6_dense_weights as fdw
