...
from flashinfer.b12x.comm.pcie import _twoshot_cute
from flashinfer.b12x.comm.pcie.pcie_oneshot import _OwnedSharedBuffer
...
def test_twoshot_odd_eager_to_graph_transition_seeds_slot_bias(
    ...
    monkeypatch.setattr(
        "flashinfer.b12x.comm.pcie.pcie_twoshot._is_current_stream_capturing",
    ...
    monkeypatch.setattr(
        "flashinfer.b12x.comm.pcie.pcie_twoshot.get_twoshot_launcher",
        _get_launcher,
    )
    monkeypatch.setattr(
        "flashinfer.b12x.comm.pcie.pcie_twoshot.is_twoshot_launcher_prepared",
        lambda *args: True,
    )
