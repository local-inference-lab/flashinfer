...
def test_benchmark_prepares_distinct_stable_eager_and_graph_channels() -> None:
    source = (
        _ROOT / "benchmarks" / "b12x" / "benchmark_pcie_oneshot_control_node.py"
...
@pytest.mark.parametrize(
    "relative_path",
    [
        "benchmarks/b12x/benchmark_pcie_oneshot_control_node.py",
        "benchmarks/b12x/run_pcie_oneshot_control_node_ab.py",
    ],
)
