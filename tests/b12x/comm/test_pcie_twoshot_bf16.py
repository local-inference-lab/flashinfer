...
Run with torchrun on 4 GPUs:
    ...
    NCCL_ALGO=Ring python -m torch.distributed.run --nproc-per-node=4 \
        tests/b12x/comm/test_pcie_twoshot_bf16.py
...
from flashinfer.b12x.comm.pcie import PCIeTwoShotBF16
from flashinfer.b12x.comm.pcie._twoshot_bf16_cute import (
    get_twoshot_bf16_allreduce_launcher,
    get_twoshot_bf16_launcher,
)
from flashinfer.b12x.comm.pcie.pcie_twoshot_bf16 import _make_layout
...
def test_graph_capture_requires_caller_owned_outputs(monkeypatch) -> None:
    import flashinfer.b12x.comm.pcie.pcie_twoshot_bf16 as twoshot_bf16
