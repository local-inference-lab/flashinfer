...
def _bind_attention_with_plan(
    ...
    *,
    ...
    from flashinfer.b12x.attention._shared.contiguous import (
...
def test_contiguous_typed_smem_boundary_rejects_and_replays_graph_oracle() -> None:
    ...
    from flashinfer.b12x.attention._shared.contiguous.forward import ContiguousAttentionForwardKernel
