...
from tests.b12x._reference import dsv4_extra_ref, dsv4_ref, glm_ref, prefill_ref

import flashinfer.b12x.attention._shared.mla.api as mla_api
from flashinfer.b12x.attention._shared.mla.api import (
    sparse_mla_decode_forward as _sparse_mla_decode_forward,
    sparse_mla_extend_forward as _sparse_mla_extend_forward,
)
from flashinfer.b12x.attention._shared.mla.compressed_api import (
    compressed_sparse_mla_decode_forward as _compressed_sparse_mla_decode_forward,
)
from flashinfer.b12x.attention._shared.mla.compressed_reference import (
    compressed_sparse_mla_page_nbytes,
    compressed_sparse_mla_reference,
    pack_compressed_sparse_mla_kv_cache_reference,
)
from flashinfer.b12x._lib.intrinsics import get_sm_version
from flashinfer.b12x.attention.compressed_sparse_mla._scratch import (
    B12XCompressedSparseMLAScratchCaps,
    _compressed_sparse_mla_scratch_layout,
    _materialize_compressed_sparse_mla_scratch,
)

from tests.b12x._reference.helpers import require_b12x as _require_b12x
...
def test_cache_block_stride_distinguishes_flat_contiguous_and_packed_views() -> None:
    import flashinfer.b12x.attention._shared.mla.kernel as decode_kernel
    import flashinfer.b12x.attention._shared.mla.prefill as prefill_dispatch
    import flashinfer.b12x.attention._shared.mla.prefill_mg as prefill_mg
    from flashinfer.b12x.attention._shared.mla.traits import ModelType
...
def _make_glm_decode_inputs(device: torch.device, num_q_heads: int = _NUM_Q_HEADS):
    ...
    from flashinfer.b12x.attention._shared.workspace import B12XAttentionWorkspace
...
def test_glm_decode_default_routes_to_sm120(monkeypatch) -> None:
    ...
    import flashinfer.b12x.attention._shared.mla.kernel as unified_launch
...
def test_dsv4_compressed_decode_routes_to_sm120_and_matches_reference(
    ...
    import flashinfer.b12x.attention._shared.mla.kernel as launch
...
def test_dsv4_compressed_prefill_mode_routes_to_unified_prefill(
    ...
    import flashinfer.b12x.attention._shared.mla.kernel as unified_pkg
...
def _run_unified_dsv4(device, *, topk, forced_num_splits, seed):
    ...
    from flashinfer.b12x.attention._shared.mla.kernel import run_unified_decode
...
def test_unified_prefill_dual_cache_80_heads_split_tail_matches_extra_ref(topk: int) -> None:
    ...
    device = require_b12x_sparse_mla()
    from flashinfer.b12x.attention._shared.mla.kernel import run_unified_prefill
...
def _make_glm_sparse_scratch(device, *, topk, max_chunks, num_heads, s_kv):
    from flashinfer.b12x.attention.sparse_mla._scratch import (
...
def test_unified_decode_mixed_length_routes_to_per_token_kernel() -> None:
    ...
    device = require_b12x_sparse_mla()
    import flashinfer.b12x.attention._shared.mla.kernel as L
