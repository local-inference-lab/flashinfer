...
from flashinfer.b12x.attention.paged._forward import (
...
from flashinfer.b12x.attention.paged.forward_paged import (
    PagedBf16ExtendRawForwardKernel,
    PagedFp8DecodeRawForwardKernel,
    PagedFp8ExtendRawForwardKernel,
)
from flashinfer.b12x.attention.paged.merge import PagedPersistentMergeKernel
from flashinfer.b12x.attention.paged.reference import paged_attention_reference
from flashinfer.b12x.attention.paged.traits import select_paged_forward_traits_from_plan
from flashinfer.b12x._lib.compiler import (
    KernelCompileSpec,
    compile as b12x_compile,
    run_compiled,
)
from flashinfer.b12x._lib.utils import current_cuda_stream
from flashinfer.b12x.attention._shared.contiguous.api import clear_attention_caches
from flashinfer.b12x.attention.paged._forward import paged_attention_forward
from flashinfer.b12x.attention.paged._scratch import B12XPagedAttentionScratchCaps, plan_paged_attention_scratch
from flashinfer.b12x.attention.paged.planner import create_paged_plan

from tests.b12x._reference.helpers import require_b12x
from tests.b12x._reference.paged_attention_helpers import make_paged_inputs, quantize_paged_kv_cache_e4m3
