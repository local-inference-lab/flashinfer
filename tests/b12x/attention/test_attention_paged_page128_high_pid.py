...
from benchmarks.b12x.benchmark_paged_attention import _capture_backend_graph
from flashinfer.b12x.attention.paged._scratch import (
    B12XPagedAttentionScratchCaps,
    plan_paged_attention_scratch,
)
from flashinfer.b12x.attention.paged.planner import plan_decode_graph_capacity
