...
from flashinfer.b12x.attention.qsa._sparse_gqa import launch_sparse_paged_gqa
from flashinfer.b12x.attention.qsa import _sparse_gqa_cute_config as cute_config
from flashinfer.b12x.attention.qsa import _sparse_gqa as sparse_gqa
from flashinfer.b12x.attention.qsa._contract import _target_splits
...
def test_split_merge_matches_softmax_with_empty_heads_and_changed_graph_inputs(
    ...
    from flashinfer.b12x.attention.paged._selected_forward import launch_sparse_gqa_merge
...
def test_cooperative_merge_preserves_order_bitwise_under_changed_graph_inputs(
    ...
    from flashinfer.b12x.attention.paged import _selected_forward as implementation
...
def test_large_prefill_selected_paged_gqa_matches_split_for_full_selection(
    ...
    from flashinfer.b12x.attention.qsa._sparse_gqa_cute import (
