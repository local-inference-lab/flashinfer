...
from flashinfer.b12x.attention._shared.mla.api import MLASparseDecodeMetadata, MLASparseExtendMetadata, sparse_mla_decode_forward, sparse_mla_extend_forward
from flashinfer.b12x.attention._shared.mla.packed import extract_packed_kv_runtime_views
...
class _FakeMLAWorkspace:
    ...
    def bind(
        ...
        *,
        ...
        from flashinfer.b12x.attention.sparse_mla._scratch import build_sparse_mla_binding
...
def test_sparse_mla_decode_keeps_query_head_shape(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "flashinfer.b12x.attention._shared.mla.api.sparse_mla_reference",
