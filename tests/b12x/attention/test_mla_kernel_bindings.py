...
def test_b12x_mla_custom_ops_have_fake_dispatch() -> None:
    ...
    __import__("flashinfer.b12x.attention._shared.mla.kernel")
    __import__("flashinfer.b12x.attention._shared.mla.prefill")
    ...
    __import__("flashinfer.b12x.attention._shared.mla.prefill_mg")
...
def test_glm_prefill_partitions_120_heads_as_32_16_8(monkeypatch) -> None:
    ...
    import flashinfer.b12x.attention._shared.mla.prefill_mg as prefill_mg
    from flashinfer.b12x.attention._shared.mla.prefill import run_unified_prefill
    from flashinfer.b12x.attention._shared.mla.traits import ComputeMode, ModelType, ScaleFormat
...
def test_prefill_mg_heads8_uses_flat_valid_hpb_launcher(monkeypatch) -> None:
    __import__("flashinfer.b12x.attention._shared.mla.prefill_mg")
    import flashinfer.b12x.attention._shared.mla.prefill_mg as prefill_mg
    from flashinfer.b12x.attention._shared.mla.prefill_mg import run_unified_prefill_mg
    from flashinfer.b12x.attention._shared.mla.traits import ComputeMode, ModelType, ScaleFormat
