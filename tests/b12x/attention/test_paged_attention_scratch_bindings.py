...
import flashinfer.b12x.attention.paged._scratch as scratch_api
from flashinfer.b12x.attention.paged.reference import paged_attention_reference
from flashinfer.b12x.attention.paged._scratch import B12XPagedAttentionBinding, B12XPagedAttentionScratchCaps, plan_paged_attention_scratch
...
def test_mimo_v25_fp8_decode_graph_non_split_ignores_worklist_bucket_shape(
    ...
    monkeypatch.setattr(
        "flashinfer.b12x.attention.paged.graph_replay.update_regular_decode_graph_chunk_metadata",
