...
def test_plan_indexer_scratch_applies_policy_fused_merge() -> None:
    ...
    from flashinfer.b12x.attention.dsa_indexer.fused_indexer import _FORCE_LAST_CTA
...
def test_dsa_indexer_merge_generator_races_both_arms() -> None:
    from flashinfer.b12x.policy.generation.providers.tunable import (
...
def test_dsa_indexer_profile_generator_merges_qualification_and_race(monkeypatch) -> None:
    ...
    from flashinfer.b12x.attention.dsa_indexer._policy import DSA_INDEXER_POLICY
    from flashinfer.b12x.policy.generation.reducer import DecisionRecord
    from flashinfer.b12x.policy.generation.providers.tunable import DsaIndexerProfileGenerator
    from flashinfer.b12x.policy.serialization import _planner_node
    from flashinfer.b12x.policy.types import FrozenMapping
