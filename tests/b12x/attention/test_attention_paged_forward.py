...
from benchmarks.b12x.benchmark_paged_attention import (
...
from flashinfer.b12x.attention.paged._forward import _build_extend_forward_kernel
...
from tests.b12x._reference.paged_attention_helpers import quantize_paged_kv_cache_e4m3
...
def test_paged_extend_dense_page128_compile_key_uses_fixed_capacity(
    ...
    import flashinfer.b12x.attention.paged._forward as paged_api
