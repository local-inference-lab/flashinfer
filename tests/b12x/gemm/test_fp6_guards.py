...
from flashinfer.b12x._lib.utils import mxfp6_packed_k_bytes, mxfp6_tile_k
...
def test_moe_w6a8_mxfp6_format_dtypes() -> None:
    ...
    from flashinfer.b12x.integration import tp_moe  # retired pre-facade API (module TODO)
