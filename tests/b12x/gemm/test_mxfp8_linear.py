...
Curated from b12x tests/b12x/test_gemm_mxfp8_linear.py (kept whole — it was
already tight).
"""
...
from flashinfer.b12x._lib.utils import convert_sf_from_mma_layout
from flashinfer.b12x.gemm import block_fp8_linear as bfl
from flashinfer.b12x.gemm import blockscaled, mxfp8_linear
...
def test_mm_uses_quantizer_without_scale_padding_initialization(
    ...
    from flashinfer.b12x.gemm._shared import block_fp8
...
def test_mm_quantizer_reuses_planned_capacity_under_frozen_resolution() -> None:
    ...
    from flashinfer.b12x._lib.quant import mxfp8_rows
