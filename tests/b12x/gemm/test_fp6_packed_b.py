...
def _gemm_operands(m: int, n: int, k: int, source_format: str):
    ...
    from flashinfer.b12x._lib.fp6 import SF_VEC_SIZE_FP6, as_grouped_mxfp6_scale_view
...
def test_gemm_weight_selection_threshold(monkeypatch):
    ...
    """
    import flashinfer.b12x.quantization.mxfp6.fp6_dense_weights as fdw
...
def test_custom_op_accepts_packed_weight():
    ...
    from flashinfer.b12x.quantization.mxfp6.fp6_dense_weights import quantize_dense_weight_to_fp6
