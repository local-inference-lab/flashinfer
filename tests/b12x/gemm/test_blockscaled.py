...
Curated from b12x tests/b12x/test_gemm_stack.py: flashinfer-core cuDNN oracle
...
from flashinfer.b12x._lib import dense_gemm as dense_module
...
def test_blockscaled_public_surface_and_compatibility_aliases() -> None:
    from flashinfer.b12x.gemm import mxfp8_linear, tensor_fp8_linear
