...
from flashinfer.b12x._lib.dense_gemm import (
    dense_gemm,
    dense_gemm_fused_quant_a,
    dense_gemm_fused_quant_a_grouped,
)
from flashinfer.b12x._lib.quant.mxfp8_rows import quantize_mxfp8_rows_cute
from flashinfer.b12x.gemm._shared.wo_mxfp8 import (
    dequantize_mxfp8_rows_torch,
    empty_mxfp8_rows_for_dense_gemm,
    quantize_mxfp8_rows_torch,
)

from tests.b12x._reference.helpers import dequantize_grouped_nvfp4, require_b12x
...
def test_mxfp8_quant_planned_capacity_reuses_callable(capacity, dtype, monkeypatch) -> None:
    import flashinfer.b12x._lib.quant.mxfp8_rows as quant_module
...
def test_mxfp8_decode_quant_finite_bit_patterns_match_scalar(dtype) -> None:
    from flashinfer.b12x._lib.quant.mxfp8_rows import _get_compiled_mxfp8_rows_quant
