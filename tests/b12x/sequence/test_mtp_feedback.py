...
from flashinfer.b12x.sequence import mtp_feedback as mtp
from flashinfer.b12x.sequence.mtp_feedback import _cute_norm
...
def test_capacity_specialization_is_reused_for_distinct_live_counts_when_frozen() -> None:
    from flashinfer.b12x.sequence.mtp_feedback._cute_prefill import (
...
def test_target_geometry_surfaces_cute_launch_failure(
    ...
    from flashinfer.b12x.sequence.mtp_feedback import _kernels
