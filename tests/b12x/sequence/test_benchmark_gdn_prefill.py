...
from benchmarks.b12x import benchmark_gdn_decode
from benchmarks.b12x._gdn_prefill_race import balanced_order, policy_context_from_file, select_cases
from benchmarks.b12x.benchmark_delta_prefill_regression import compare_reports
...
def test_explicit_profile_requires_matching_device_and_query(tmp_path, compressed):
    from flashinfer.b12x.policy import DeviceIdentity, PolicySource, PreplannedPolicyNotFoundError
    from flashinfer.b12x.policy.generation.providers.delta_prefill import prefill_cases
    from flashinfer.b12x.sequence.gdn_prefill._policy import GDN_PREFILL_POLICY, GdnPrefillQuery
