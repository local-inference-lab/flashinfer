...
from flashinfer.b12x.sequence._shared.kda_math import kda_beta, kda_log_decay, l2_normalize
from flashinfer.b12x.sequence.kda_prefill.reference import (
    MirrorPolicy,
    prefill_kda,
...
def test_recurrent_oracle_matches_decode_kda_token_by_token() -> None:
    from flashinfer.b12x.sequence.gdn_decode.reference import decode_kda
...
def make_binding(
    ...
    **caps_extra,
    ...
    from flashinfer.b12x.sequence.kda_prefill import _impl as impl
...
def test_prepare_kernel_matches_chunk_mirror(lengths, lower_bound) -> None:
    ...
    from flashinfer.b12x.sequence._shared.delta_prefill._cute_kernels import run_prepare, run_prologue, workspace_tiles
...
def test_prologue_reports_malformed_metadata(mutate, bit) -> None:
    from ..conftest import require_b12x
    from flashinfer.b12x.sequence._shared.delta_prefill._cute_kernels import run_prepare, run_prologue
...
def test_op_lower_bounds_and_saturated_gates(lower_bound, gate_profile) -> None:
    ...
    _run(binding, inputs)
    torch.cuda.synchronize(device)
    from flashinfer.b12x.sequence._shared.delta_prefill._cute_kernels import workspace_tiles
...
def test_op_three_window_ring_reuse_is_capture_safe() -> None:
    ...
    from ..conftest import require_b12x
    from flashinfer.b12x.policy import PolicyContext, PolicyMode
    from flashinfer.b12x.policy.components import KDA_PREFILL
    from flashinfer.b12x.sequence.kda_prefill import KdaPrefillConfig
...
def test_op_capacity_specialization_is_reused_under_frozen_resolution() -> None:
    ...
    from flashinfer.b12x.sequence._shared.delta_prefill import _cute_kernels as kernels
