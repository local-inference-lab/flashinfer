...
from flashinfer.b12x.sequence._shared.delta_prefill.workspace import tiles_capacity
...
def test_gpu_zero_transfer_boundary_matches_dense_product(special, poison_local):
    from flashinfer.b12x.sequence.gdn_prefill._parallel_kernels import compile_auxiliary
...
def test_gpu_zero_transfer_summary_matches_unskipped_recurrence(source, summary):
    from flashinfer.b12x.sequence._shared.delta_prefill._cute_kernels import (
        _compile_recurrence, run_prepare, run_prologue,
    )
    from flashinfer.b12x.sequence._shared.delta_prefill.workspace import WorkspaceRecord
    from flashinfer.b12x.sequence.gdn_prefill._parallel_kernels import compile_auxiliary
