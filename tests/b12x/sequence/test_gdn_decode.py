...
def test_research_qwen_cute_stages_are_graph_safe_and_correct(
    ...
    from flashinfer.b12x.sequence.gdn_decode._cute_kernels import (
        run_gated_rmsnorm,
...
def test_public_qwen38_surfaces_cute_launch_failure(
    ...
    from flashinfer.b12x.sequence.gdn_decode import _cute_kernels
...
def test_bounded_metadata_validation_preserves_error_bits_with_large_slot_ids(
    ...
    from flashinfer.b12x.sequence.gdn_decode import _kernels as kernels
