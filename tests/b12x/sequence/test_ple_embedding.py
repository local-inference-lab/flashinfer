...
from flashinfer.b12x.sequence import ple_embedding
from flashinfer.b12x.sequence.ple_embedding import reference
from flashinfer.b12x.sequence.ple_hash.reference import (
    nth_prime_after,
...
def test_cuda_graph_replay_uses_bound_storage_without_allocating(
    ...
    from flashinfer.b12x.sequence.ple_embedding import _kernels
    from flashinfer.b12x.sequence.ple_hash import _kernels as hash_kernels
