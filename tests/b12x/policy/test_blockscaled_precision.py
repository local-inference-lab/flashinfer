...
from flashinfer.b12x.gemm.blockscaled._policy import (
...
from flashinfer.b12x.policy.catalog import ONESHOT_COMPONENTS, list_planning_components
from flashinfer.b12x.policy.generation.providers.blockscaled import BlockscaledPrecisionGenerator, precision_cases, qualifies
from flashinfer.b12x.policy.generation.reducer import DecisionRecord
...
def test_gb10_timing_gate_requires_p0_stable_sm_clock_and_no_throttling():
    from benchmarks.b12x.benchmark_blockscaled_precision import _clock_checks
...
def test_precision_generator_prefers_a16_at_equal_latency(tmp_path):
    ...
    from flashinfer.b12x.gemm.blockscaled._policy import A16_CONFIGS
    from flashinfer.b12x.policy.generation import CheckpointStore, GenerationContext, GenerationSettings, SweepCandidate, SweepMeasurement
...
def test_auto_precision_preserves_explicit_mode_and_unqualified_source_layout(monkeypatch):
    from types import SimpleNamespace
    import torch
    from flashinfer.b12x.gemm.blockscaled._a16 import _select_mode

    config = BlockscaledConfig(a16_rows=((8, 64, 64, 1),))
    monkeypatch.setattr("flashinfer.b12x.gemm.blockscaled._policy.resolve_precision",
