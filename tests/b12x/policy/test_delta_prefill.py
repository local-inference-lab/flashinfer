...
from flashinfer.b12x.policy.generation import CheckpointStore, GenerationContext, GenerationSettings, SweepMeasurement
...
from flashinfer.b12x.sequence.gdn_prefill._policy import GDN_PREFILL_POLICY, GdnPrefillConfig, GdnPrefillQuery
from flashinfer.b12x.sequence.kda_prefill._policy import KDA_PREFILL_POLICY, KdaPrefillConfig, KdaPrefillQuery
from flashinfer.b12x.sequence._shared.delta_prefill.workspace import (
...
def test_public_prefill_plan_uses_typed_resolution_without_tensor_allocation(recipe, monkeypatch):
    from flashinfer.b12x.policy.generation.delta_prefill_cases import prefill_op
