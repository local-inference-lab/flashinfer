...
from flashinfer.b12x.policy.generation import ComponentGeneratorRegistry
from flashinfer.b12x.policy.generation.moe_corpus import COMMON_PREFILL_TOKEN_CAPACITIES
...
def test_unknown_gpu_uses_the_component_heuristic() -> None:
    ...
    from flashinfer.b12x.policy import DeviceIdentity
