...
from flashinfer.b12x.policy import DetectedDevice, EMBEDDED_REGISTRY
...
from flashinfer.b12x.policy.generation.providers.gemm import _bf16_vocab_projection_cases
from flashinfer.b12x.tools.inspect_model_policy import (
    _MODEL_FACTORIES,
    _canonical_model,
...
def test_multi_target_profile_id_uses_matching_detected_device(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "flashinfer.b12x.tools.inspect_model_policy.detect_device",
...
def test_auto_device_selects_detected_cuda_device(monkeypatch) -> None:
    ...
    monkeypatch.setattr("flashinfer.b12x.tools.inspect_model_policy.detect_device", detect)
