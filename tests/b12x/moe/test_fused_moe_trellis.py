...
from flashinfer.b12x.moe.fused_moe import META as FUSED_MOE_META
from flashinfer.b12x.moe._shared.kernels.w4a16.host import plan_w4a16_buffers
from flashinfer.b12x.moe._shared.kernels.w4a16.host import make_w4a16_packed_buffers
...
from flashinfer.b12x._lib.quant.sqg_e4m3 import (
    sqg_xor_cheb_t12_direct_lut_cpu,
)
from flashinfer.b12x._lib.quant.sqg_fp16_d3l import sqg_fp16_d3l_direct_lut_cpu
...
def test_rotation_placeholder_must_be_materialized_before_capture(
    ...
    import flashinfer.b12x.moe._shared.kernels.w4a16.kernel as w4a16_kernel
...
def test_qsrt_pdynamic_cache_key_ignores_expert_count() -> None:
    ...
    from flashinfer.b12x.moe._shared.kernels.w4a16.kernel import W4A16FusedMoeKernel
