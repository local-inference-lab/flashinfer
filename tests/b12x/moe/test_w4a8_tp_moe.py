...
from tests.b12x._reference.helpers import prepare_tp_moe_fp4_experts, run_tp_moe_fp4
...
def test_unswizzle_batched_matches_reference() -> None:
    ...
    from flashinfer.b12x.moe.fused_moe._impl import _unswizzle_block_scales_batched
    from flashinfer.b12x.moe._shared.kernels.reference import unswizzle_block_scale
...
def _w4a8_oracle(m: int, seed: int) -> tuple[torch.Tensor, torch.Tensor]:
    ...
    from flashinfer.b12x.moe.fused_moe._impl import _derive_w4a8_weight_grids
...
def test_nvfp4_fused_micro_graph_replay_with_prequeued_aux_work() -> None:
    ...
    from benchmarks.b12x.benchmark_moe import make_shape_only_expert_weights
    from flashinfer.b12x.moe.fused_moe._impl import (
