...
from flashinfer.b12x.moe.fused_moe._impl import _DynamicMoEW4A8Launch, current_cuda_stream
...
from tests.b12x._reference.trellis_moe import (
    build_trellis_weight,
    trellis_moe_reference,
)
from tests.b12x._reference.helpers import require_b12x
from tests.b12x.moe.test_w4a8_dynamic_kernel import (
    _OPT_LEVEL_2,
    _fake_f32,
    _fake_i32,
    _gptr,
    ...
    *,
    ...
    compiled = b12x_compile(
        ...
        compile_spec=KernelCompileSpec.from_fields(
            "tests.b12x.w4a8_dynamic.trellis",
            1,
            ("recipe", recipe),
            ("tile_m", tile_m),
