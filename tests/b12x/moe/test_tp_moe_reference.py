...
from flashinfer.b12x._lib.intrinsics import fp4_quantize_values_torch
...
def _make_b12x_moe_binding(
    ...
    from tests.b12x._reference.helpers import make_tp_moe_fp4_binding, prepare_tp_moe_fp4_experts
