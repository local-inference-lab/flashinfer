...
from flashinfer.b12x.policy import MOE_DECODE, PolicyContext, PolicySource, get_auto_policy
...
def test_native_nvfp4_preparation_validates_scale_storage(name, invalid):
    from flashinfer.b12x.moe._shared.kernels.w4a16.prepare import prepare_w4a16_modelopt_native_weights
    inputs = dict(
...
def test_auto_shared_weights_precision_plans_replay_without_resolution(monkeypatch):
    ...
    import flashinfer.b12x.moe._shared.kernels.w4a16.prepare as preparation
