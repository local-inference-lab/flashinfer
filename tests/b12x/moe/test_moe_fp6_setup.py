...
from flashinfer.b12x._lib.utils import mxfp6_tile_k, mxfp6_num_k_blocks
from flashinfer.b12x.moe._shared.kernels import mxfp6_moe
...
def test_moe_static_dynamic_init_tile_k_default():
    ...
    from flashinfer.b12x.moe._shared.kernels.static import _MoEStaticKernelBase
