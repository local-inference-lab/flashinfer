...
from tests.b12x._reference.helpers import (
    make_tp_moe_fp4_binding,
    prepare_tp_moe_fp4_experts,
    run_tp_moe_fp4,
)
from tests.b12x._reference.w4a16_reference import compare_to_reference, moe_reference_w4a16
...
def test_trellis_w4a16_capture_prewarm_uses_exact_runtime_key(
    ...
    from flashinfer.b12x.moe.fused_moe import _impl as tp_moe_impl
    from flashinfer.b12x.moe._shared.kernels.w4a16 import kernel as w4a16_kernel
...
def test_w4a16_activation_amax_calibration_tracks_routed_inputs_and_fc2_inputs(
    ...
    monkeypatch.setattr(
        "flashinfer.b12x.moe._shared.kernels.w4a16.kernel.compile_w4a16_fused_moe",
