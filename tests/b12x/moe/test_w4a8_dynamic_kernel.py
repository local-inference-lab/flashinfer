...
from flashinfer.b12x._lib.intrinsics import _fp4_encode_nibbles, fp4_quantize_values_torch
...
from flashinfer.b12x.moe._shared.kernels.dynamic import MoEDynamicKernelBackend
    ...
    *,
    ...
    compiled = _compile_or_override(
        ...
        compile_spec=KernelCompileSpec.from_fields(
            "tests.b12x.w4a8_dynamic.direct",
            1,
            ("recipe", recipe),
            ("activation", activation),
            ("tile_m", tile_m),
