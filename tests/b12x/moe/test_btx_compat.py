...
from flashinfer.b12x.moe._shared.btx_schema import matrix_atom_bytes, rate_code
...
from flashinfer.b12x.moe._shared.kernels.w4a16.btx_synth import (
    BtxSynthConfig,
...
def test_v1_lift_matches_synth_btx(tmp_path) -> None:
    from flashinfer.b12x.moe._shared.kernels.w4a16.btx import read_btx_layer
    from flashinfer.b12x.moe._shared.kernels.w4a16.btx_synth import write_btx_checkpoint
