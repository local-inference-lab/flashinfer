...
from flashinfer.b12x._lib.intrinsics import pack_grouped_fp4_values, swizzle_block_scale
...
from flashinfer.b12x.moe._shared.kernels.micro import MoEMicroKernelBackend as NVFP4MoEMicroKernelBackend
...
def test_flashinfer_fp4_e8m0_k32_oracle_matches_python_oracle_on_deepseek_v4_flash_layer() -> None:
    _require_flashinfer_trtllm_cuda()
    # benchmarks/b12x/ still uses the flat API; unskip once it is migrated.
    pytest.importorskip("benchmarks.b12x.benchmark_moe")
