...
from benchmarks.b12x.benchmark_ds4_moe import make_synthetic_mxfp4_moe
...
def test_w4a8_mx_dynamic_tile_density_boundaries(
    ...
    import flashinfer.b12x.moe.fused_moe._impl as tp_moe
...
def _run(
    ...
    *,
    ...
    from tests.b12x._reference.helpers import run_tp_moe_fp4
...
def test_w4a8_mx_situ_cuda_graph_replay_matches_oracle(m: int) -> None:
    _skip_if_unavailable()
    from flashinfer.b12x.moe._shared.kernels.reference import moe_reference_w4a8_mx
    from flashinfer.b12x.moe.fused_moe._impl import b12x_moe_fp4
    from tests.b12x._reference.helpers import make_tp_moe_fp4_binding
...
def test_w4a8_mx_kimi_k3_tp8_situ_reuses_checkpoint_storage() -> None:
    ...
    _skip_if_unavailable()
    from flashinfer.b12x.moe._shared.kernels.reference import moe_reference_w4a8_mx
    from flashinfer.b12x.moe.fused_moe import (
        plan_weights,
        prepare_weights,
        run,
    )
...
def test_w4a8_mx_dynamic_graph_replay_tracks_routing_updates() -> None:
    ...
    _skip_if_unavailable()
    from flashinfer.b12x.moe.fused_moe._impl import b12x_moe_fp4, clear_tp_moe_caches
    from tests.b12x._reference.helpers import make_tp_moe_fp4_binding
