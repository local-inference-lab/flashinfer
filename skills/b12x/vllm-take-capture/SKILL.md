...
```bash
python skills/b12x/vllm-take-capture/scripts/take_vllm_capture.py --profile-dir /tmp/vllm-ds4-decode
```
...
```bash
python skills/b12x/vllm-take-capture/scripts/take_vllm_capture.py --profile-dir /absolute/profile/dir
```
