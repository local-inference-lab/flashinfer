...
``flashinfer/b12x/integration/`` (``tp_moe.py``, ``mla.py``, ...).  FP6 follows the
same pattern via ``flashinfer/b12x/integration/vllm/``.
...
flowchart LR
    ...
    subgraph shim [flashinfer.b12x.integration.vllm]
...
Produce checkpoints with ``scripts/b12x/quantize_model_fp6.py``.
...
```text
flashinfer/b12x/integration/vllm/fp6_serving.py
flashinfer/b12x/integration/vllm/plugin.py
flashinfer/b12x/integration/vllm/__init__.py
```

Register the entry point as documented in
[flashinfer/b12x/integration/vllm/README.md](../../flashinfer/b12x/integration/vllm/README.md).
