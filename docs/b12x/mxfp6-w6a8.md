...
`scripts/b12x/quantize_model_fp6.py` (dense) and `scripts/b12x/quantize_moe_fp6.py`
(MoE) export HF checkpoints to the FP6 schema (safetensors only, architecture
discovery, MSE-refined block scales). `scripts/b12x/dequantize_fp6_to_bf16.py`
