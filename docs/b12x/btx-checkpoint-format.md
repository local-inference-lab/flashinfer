...
`flashinfer/b12x/moe/_shared/btx_schema.py`.
...
`flashinfer/b12x/moe/_shared/trellis_codebooks.py`). The container's payload bytes are
...
- **Declared, unfused**: pair-kind sets containing `P44` (whole-expert K4
  ...
  (`flashinfer/b12x/moe/_shared/kernels/w4a16/mixed_trellis.py`) are the execution
  vehicles.
